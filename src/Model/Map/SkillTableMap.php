...
class SkillTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.SkillTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Model\\Skill';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Skill';
     ...
     */
    const COL_ID = 'skill.id';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'skill.title';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SkillTableMap::COL_ID, SkillTableMap::COL_TITLE, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SkillTableMap::COL_ID => 0, SkillTableMap::COL_TITLE => 1, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Model\\Skill');
  ...
  array (
    ...
    /**
     * Method to invalidate the instance pool of all tables related to skill     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SkillTableMap::COL_TITLE);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Skill) { // it's a model object
