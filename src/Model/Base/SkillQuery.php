...
use App\Model\Map\SkillTableMap;
 ...
 * @method     ChildSkillQuery orderByTitle($order = Criteria::ASC) Order by the title column
 *
 * @method     ChildSkillQuery groupById() Group by the id column
 * @method     ChildSkillQuery groupByTitle() Group by the title column
 *
 ...
 *
 * @method     ChildSkillQuery leftJoinJobSkill($relationAlias = null) Adds a LEFT JOIN clause to the query using the JobSkill relation
 * @method     ChildSkillQuery rightJoinJobSkill($relationAlias = null) Adds a RIGHT JOIN clause to the query using the JobSkill relation
 * @method     ChildSkillQuery innerJoinJobSkill($relationAlias = null) Adds a INNER JOIN clause to the query using the JobSkill relation
 *
 * @method     ChildSkillQuery joinWithJobSkill($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the JobSkill relation
 *
 * @method     ChildSkillQuery leftJoinWithJobSkill() Adds a LEFT JOIN clause and with to the query using the JobSkill relation
 * @method     ChildSkillQuery rightJoinWithJobSkill() Adds a RIGHT JOIN clause and with to the query using the JobSkill relation
 * @method     ChildSkillQuery innerJoinWithJobSkill() Adds a INNER JOIN clause and with to the query using the JobSkill relation
 *
 ...
 * @method     ChildSkill findOneByTitle(string $title) Return the first ChildSkill filtered by the title column *
 ...
 * @method     ChildSkill requireOneByTitle(string $title) Return the first ChildSkill filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildSkill[]|ObjectCollection findByTitle(string $title) Return ChildSkill objects filtered by the title column
...
abstract class SkillQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \App\Model\Base\SkillQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\App\\Model\\Skill', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title FROM skill WHERE id = :p0';
        try {
    ...
    public function filterByTitle($title = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SkillTableMap::COL_TITLE, $title, $comparison);
    }
    ...
    public function filterByJobSkill($jobSkill, $comparison = null)
    {
        if ($jobSkill instanceof \App\Model\JobSkill) {
            return $this
                ->addUsingAlias(SkillTableMap::COL_ID, $jobSkill->getSkillId(), $comparison);
